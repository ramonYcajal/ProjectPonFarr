...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2016 a las 22:09:55
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `cambiarContrasena`(IN `_nombre` VARCHAR(50), IN `_contrasenaVieja` VARCHAR(50), IN `_contrasenaNueva` VARCHAR(50), OUT `_resultado` INT)
begin
	declare contar  int;
