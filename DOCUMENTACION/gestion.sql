...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2016 a las 21:12:25
...
INSERT INTO `administracion` (`id`, `usuario`, `contrasena`) VALUES
(2, 'admin', 'admin'),
(3, 'jefe', 'jefe'),
(4, 'usuario', 'usuario');
...
INSERT INTO `estadoincidencia` (`id`, `estadoIncidencia`) VALUES
(1, 'Resuelta'),
(2, 'No resuelta'),
(3, 'En trámite');
